    ...
    <View style={{flex: 1, width: screenWidth}}>
      <View style={{flex: 0.6}}>
        ...
        <View style={styles.buttonContainer}>
          <CustomButton
            text="Species Detection &nbsp;"
            onPress={() => navigate('/species-info')}
            button={[styles.buttonn, {backgroundColor: '#98A931'}]}
          />
          <CustomButton
            text="Boundary Mapping"
            onPress={() => navigate('/boundary-mapping')}
            button={[styles.buttonn, {backgroundColor: '#84972D'}]}
          />
           {/* <CustomButton
            text="Dev Boundary Mapping"
            onPress={() => navigate('/dev-boundary-mapping')}
            button={[styles.buttonn, {backgroundColor: '#84972D'}]}
          /> */}
        </View>
